...
def main():
    ...
    # 设置日志目录
    log_dir = "/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/newlogs/model_ICDAR2017_1_log"
    ...
    image_path = os.path.join(data_root, "ICDAR2017_1")  # flower data set path
    ...
    patience = 80  # 连续多少个epoch无提升就停止（可调）
    ...
    # 可选：acc 的最小提升阈值，防止抖动
    min_delta_acc = 1e-5  # 例如 1e-4 或 1e-3（acc通常是0~1）


    save_dir = "/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/model_weight/model_ICDAR2017_1_models"  # 保存模型的目录,
    os.makedirs(save_dir, exist_ok=True)
    save_path = '/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/model_weight/model_ICDAR2017_1_models/model_ICDAR2017_1.pth'
    ...
    for epoch in range(epochs):
        ...
        if val_acc > best_acc + min_delta_acc:
            best_acc = val_acc
            best_epoch = epoch + 1
            early_stop_counter = 0
    ...
    plt.savefig(r"/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/picture/model_ICDAR2017_1_plot.png", dpi=300)
    plt.show()
