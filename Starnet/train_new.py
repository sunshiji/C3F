...
def main():
    ...
    # 设置日志目录
    log_dir = "/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/newlogs/wshH_MLe2e_1_log"
    ...
    image_path = os.path.join(data_root, "MLe2e_1")  # flower data set path
    ...
    save_dir = "/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/model_weight/wshH_MLe2e_1_models"  # 保存模型的目录,
    os.makedirs(save_dir, exist_ok=True)
    save_path = '/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/model_weight/wshH_MLe2e_1_models/wshH_MLe2e_1.pth'
    ...
    plt.savefig(r"/home/szh/code/pytorchProject/Rewrite-the-Stars-main/starnet/picture/wshH_MLe2e_1_plot.png", dpi=300)
    plt.show()
